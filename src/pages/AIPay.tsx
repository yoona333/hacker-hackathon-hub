...
import { Sparkles, ArrowLeft, Terminal, ExternalLink, Loader2, Brain, Shield, CheckCircle2, XCircle } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm sm:text-lg font-bold font-mono terminal-text uppercase">{t('aiPay.title')}</span>
            </div>
          </div>
