        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold neon-text">Proposals</span>
            </div>
          </div>
          <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          >
                            <div className="font-bold text-destructive mb-1">❄️ Freeze</div>
                            <p className="text-xs text-muted-foreground">
                              Freeze an address to prevent transactions
                            </p>
                          </button>
                          <button
                          ...
                          >
                            <div className="font-bold text-success mb-1">🔓 Unfreeze</div>
                            <p className="text-xs text-muted-foreground">
                              Unfreeze an address to restore access
                            </p>
                          </button>
                        </div>
                      </div>
          ...
          <div className="space-y-4">
            ...
            {MOCK_DATA.proposals.length === 0 ? (
              ...
              MOCK_DATA.proposals.map((proposal, index) => (
                ...
                >
                  <GlassCard 
                    glow={proposal.executed ? 'green' : 'purple'}
                    className="hover:border-primary/50"
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-xl gradient-purple-blue flex items-center justify-center text-2xl font-bold">
                          #{proposal.id}
                        </div>
                        <div>
                    ...
                    {proposal.executed && (
                      <div className="mt-4 p-3 bg-success/10 rounded-lg flex items-center gap-2 text-success">
                        ...
                        <span className="text-sm">Proposal executed successfully</span>
                      </div>
                    )}
                  </GlassCard>
                </motion.div>
