  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-amber": {
          "0%, 100%": { 
            boxShadow: "0 0 15px hsl(var(--terminal-amber) / 0.4), 0 0 30px hsl(var(--terminal-amber) / 0.2)" 
          },
          "50%": { 
            boxShadow: "0 0 30px hsl(var(--terminal-amber) / 0.6), 0 0 60px hsl(var(--terminal-amber) / 0.4)" 
          },
        },
        "float": {
